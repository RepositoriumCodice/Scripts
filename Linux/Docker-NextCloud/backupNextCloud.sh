...
# backup db
sudo docker exec $NC_DB_CONTAINER mysqldump --single-transaction -h localhost -u $NC_DB_USER -p$NC_DB_PASS $NC_DB_NAME > $NC_DB_DUMP_DIR/db_dump_$NC_DB_TYPE_nextcloud.sql
